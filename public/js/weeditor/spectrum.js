            ...
            "<div class='sp-container sp-hidden'>",
                ...
                "<div class='sp-picker-container'>",
                    ...
                    "<div class='recent_use'>",
                       "<p>最近使用</p>",
                       "<ul class='clearfix'>",
                         "<li class='sp-initial sp-thumb sp-cf'></li>",
                       "</ul>",
                    "</div>",
                    "<div class='sp-button-container sp-cf' style='border-top:1px solid #ccc;padding-top:6px;'>",
    ...
    function spectrum(element, o) {
        ...
        function initialize() {
            ...
            chooseButton.bind("click.spectrum", function (e) {
                ...
                //换主题色----------------------
                var _color=$(".sp-input").val();
                $(".js_color_picker").attr("data-color",_color);
                $(".js_color_picker").attr("data-changed","1");
               //alert(color64);
                $(".scrollPanl").find(".wemeEditor *").each(function(){
                     ...
                     if( !(/rgba\(\s*0\s*,\s*0\s*,\s*0\s*,\s*0\s*\)/i).test(_this.css("border-top-color")) 
                        ...
                        &&  (_this.css("border-top-color") !="transparent") ){
                          _this.css({"border-top-color":_color});
                     }
                     ...
                     if( !(/rgba\(\s*0\s*,\s*0\s*,\s*0\s*,\s*0\s*\)/i).test(_this.css("border-right-color")) 
                        ...
                        &&  (_this.css("border-right-color") !="transparent") ){
                          _this.css({"border-right-color":_color});
                     }
                     ...
                     if( !(/rgba\(\s*0\s*,\s*0\s*,\s*0\s*,\s*0\s*\)/i).test(_this.css("border-bottom-color")) 
                        ...
                        &&  (_this.css("border-bottom-color") !="transparent") ){
                          _this.css({"border-bottom-color":_color});
                     }
                     ...
                     if( !(/rgba\(\s*0\s*,\s*0\s*,\s*0\s*,\s*0\s*\)/i).test(_this.css("border-left-color")) 
                        ...
                        &&  (_this.css("border-left-color") !="transparent") ){
                          _this.css({"border-left-color":_color});
                     }
        ...
        function reflow() {
            ...
            if (!flat) {
                container.css({"position":"absolute","left":"238.281px","top":"111px"});
