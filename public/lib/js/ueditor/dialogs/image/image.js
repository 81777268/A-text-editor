...
(function () {
    ...
    SearchImage.prototype = {
        ...
        getImageData: function(){
               ...
               // url="http://127.0.0.1:8080/load_image/list_cross_domain.do?keyWord="+key+" "+type+"&pageNum=1&pageSize=20&date="+new Date;
            ...
            //shidajian
             $.ajax({
                     type: "get",
                     dataType: "json",
                     url: "/onlineimg_list_json?_dc="+Math.random(), 
                     data: {
                        "keyWord":encodeURI(encodeURI(key)),
                        "pageNum":0,
                        "pageSize":20
                     },
